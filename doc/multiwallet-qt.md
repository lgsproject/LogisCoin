...
In order to support loading of multiple wallets in logiscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is logiscoin.cpp.
...
Changes to logiscoin.cpp
----------------------
logiscoin.cpp is the entry point into logiscoin-qt, and as such, will require some minor modifications to provide hooks for
