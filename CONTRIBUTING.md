Contributing to LogisCoin Core
============================

The LogisCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LogisCoin Core project, and is not to be
confused with overall LogisCoin Network Protocol consensus changes.

Whether a pull request is merged into LogisCoin Core rests with the project merge
...
Patches that change LogisCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the LogisCoin consensus, it must have been
...
The project leader is the release manager for each LogisCoin Core release.
