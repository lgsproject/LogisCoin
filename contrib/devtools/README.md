...
LogisCoin-Project/LogisCoin repository.
...
Setup
---------
Configuring the github-merge tool for the LogisCoin repository is done in the following way:

    git config githubmerge.repository LogisCoin-Project/LogisCoin
...
A script to optimize png files in the LogisCoin
