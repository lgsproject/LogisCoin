...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"logiscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"logiscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"logiscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
