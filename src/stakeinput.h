...
#ifndef LogisCoin_STAKEINPUT_H
#define LogisCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZLGS() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zLGSStake can take two forms
...
public:
    ...
    bool IsZLGS() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZLGS() override { return false; }
};


#endif //LogisCoin_STAKEINPUT_H
