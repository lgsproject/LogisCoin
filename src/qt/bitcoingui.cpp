                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LogisCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LogisCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and logiscoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLGS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LogisCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about LogisCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LogisCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LogisCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LogisCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a LogisCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LogisCoin Core help message to get a list with possible LogisCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LogisCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LogisCoin network", "", count));
}
...
{
    QString strTitle = tr("LogisCoin Core"); // default title
