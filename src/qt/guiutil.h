...
/** Utility functions used by the LogisCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LogisCoin addresses in monospace font
...
// Parse "logiscoin:" URI into recipient object, return true on successful parsing
