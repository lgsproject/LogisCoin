...
/* Logiscoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LogisCoin"
#define QAPP_ORG_DOMAIN "logiscoin.cc"
#define QAPP_APP_NAME_DEFAULT "LogisCoin-Qt"
#define QAPP_APP_NAME_TESTNET "LogisCoin-Qt-testnet"
