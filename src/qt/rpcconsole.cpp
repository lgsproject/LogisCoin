                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLGSPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzLGSPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzLGSPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLGSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LogisCoin RPC console.") + "<br>" +
